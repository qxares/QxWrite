...
SOURCES       = main.cpp \
		qxwrite.cpp \
		documenteditor.cpp moc_qxwrite.cpp \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents qxwrite.h documenteditor.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp qxwrite.cpp documenteditor.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_qxwrite.cpp moc_documenteditor.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_qxwrite.cpp moc_documenteditor.cpp
